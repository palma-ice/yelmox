...
fldr=tmp/ismip6/spinup_${res}_115
...
file_restart=/p/tmp/robinson/ismip6/spinup_32km_114/0/yelmo_restart.nc

fldr=tmp/ismip6/spinup_${res}_114b

paropt="ytopo.kt=2.5e-3 ymat.enh_shear=2 yneff.p=0.5 ytill.cf_ref=1.0"

# 
paropt2="yelmo.restart=${file_restart} opt.cf_time=2e3 opt.tf_time=2e3 opt.rel_time2=0.0 spinup.time_end=6e3 yelmo_init_topo.smooth_z_bed=2.0"
