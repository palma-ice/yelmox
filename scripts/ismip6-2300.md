...
paropt="ydyn.ssa_lat_bc='floating' ytopo.kt=2.5e-3 ymat.enh_shear=2 yneff.p=0.5 ytill.cf_ref=1.0 ydyn.ssa_gradbase_max=5.0"
...
fldr=tmp/ismip6/spinup_${res}_110d
file_restart=/p/tmp/robinson/ismip6/spinup_32km_110/0/yelmo_restart.nc

paropt="ydyn.ssa_lat_bc='floating' ytopo.kt=2.5e-3 ymat.enh_shear=2 yneff.p=0.5 ytill.cf_ref=1.0 ydyn.ssa_gradbase_max=5.0"

paropt2="yelmo.restart=${file_restart} opt.cf_time=2e3 opt.tf_time=2e3 opt.rel_time2=0.0 spinup.time_end=5e3"
