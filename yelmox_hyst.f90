...
program yelmox
    ...
    call nml_read(path_par,"control","dt2D_small_out",  dt2D_small_out)            ! [yr] Frequency of 2D small output 
...
!                       dim1="xc",dim2="yc",dim3="time",start=[1,1,n],ncid=ncid)
    ...
    subroutine write_step_1D_combined(reg,hyst,snp,filename,time)
