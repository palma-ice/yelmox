...
program yelmox_rtip
    ...
    ! Get output times
    call timeout_init(tm_1D,  path_par,"tm_1D",  "light",  ctl%time_init,ctl%time_end)
    call timeout_init(tm_2Dwais,path_par,"tm_2Dwais","medium-light", ctl%time_init,ctl%time_end)
    ...
    call timeout_init(tm_3D, path_par, "tm_3D", "very-heavy", ctl%time_init, ctl%time_end)
