...
!                       dim1="xc",dim2="yc",dim3="time",start=[1,1,n],ncid=ncid)
    ...
    subroutine modify_smb(smb,grd,time)
        ...
        ! NEGIS
        call scale_cf_gaussian(dsmb_0kyr,-2.0,x0=-430.0, y0=-1100.0,sigma=200.0,xx=grd%x*1e-3,yy=grd%y*1e-3)
        ...
        ! NEGIS
        call scale_cf_gaussian(dsmb_6kyr,-2.0,x0=-430.0, y0=-1100.0,sigma=200.0,xx=grd%x*1e-3,yy=grd%y*1e-3)
