...
program yelmox_esm
    ...
    write(*,*) "esm_expname:         ", trim(ctl%esm_expname)
    write(*,*) "esm_experiment:      ", trim(esmexp%experiment)
...
!                       dim1="xc",dim2="yc",dim3="time",start=[1,1,n],ncid=ncid)
    ...
    subroutine write_1D_esm(dom,filename,time)
